...
use gladius_lib::load_config::load_config;
use gladius_lib::logger_setup::logger_setup;
use gladius_lib::run_gladius::run_gladius;
...
fn main() {
    let args = gladius_lib::args::Args::parse();
